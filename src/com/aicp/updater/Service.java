...
public class Service extends IntentService {
    ...
    private static final boolean DEBUG_ALWAYS_UPDATE = true;// TODO false
    ...
    private void publishProgress() {
        ...
        final SharedPreferences preferences = Settings.getPreferences(this);
        if (true/*TODO setting*/) { // TODO also cancel from settings when disabling and already visible
            final NotificationManager notificationManager = getSystemService(NotificationManager.class);
