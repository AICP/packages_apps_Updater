...
public class Service extends IntentService {
    ...
    String MOD_VERSION = SystemProperties.get("ro.aicp.version.update", "unknown");
    ...
    private void onDownloadFinished(final long targetBuildDate, final String channel) throws IOException, GeneralSecurityException {
        try {
            ...
            if (serialno != null) {
                if ("NIGHTLY".equals(channel) || "WEEKLY".equals(channel)) {
    ...
    protected void onHandleIntent(final Intent intent) {
        ...
        try {
            ...
            final String channel = SystemProperties.get("sys.update.channel",
                preferences.getString(PREFERENCE_CHANNEL, "NIGHTLY"));
